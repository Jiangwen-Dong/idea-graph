...
def _validate_parallel_candidate_state_rows(
    ...
    shared_fields = {
        ...
        "candidate_count": candidate_count,
        "before_state_snapshot": str(ordered_rows[0].get("before_state_snapshot", "")).strip(),
        "before_state_node_count": _safe_int(ordered_rows[0].get("before_state_node_count")),
        "before_state_edge_count": _safe_int(ordered_rows[0].get("before_state_edge_count")),
        "before_state_contradiction_count": _safe_int(ordered_rows[0].get("before_state_contradiction_count")),
        "before_state_support_edge_count": _safe_int(ordered_rows[0].get("before_state_support_edge_count")),
            ...
            candidate_rows.append(
                {
                    ...
                    "before_state_snapshot": shared["before_state_snapshot"],
                    "before_state_node_count": shared["before_state_node_count"],
                    "before_state_edge_count": shared["before_state_edge_count"],
                    "before_state_contradiction_count": shared["before_state_contradiction_count"],
                    "before_state_support_edge_count": shared["before_state_support_edge_count"],
